...
async def connect():
    try:
        ...
        # code_list = [['1', 'H0EUASP0', '101W06'], ['1', 'H0EUCNT0', '101W06'], ['1', 'H0EUANC0', '101W06']]#, ['1', 'H0EUCNI0', 'HTS ID를 입력하세요']]

        ### 3-5. 국내 야간선물(CME) 호가, 체결가, 체결통보 ###
        code_list = [['1', 'H0MFASP0', '101W06'], ['1', 'H0MFCNT0', '101W06']]#, ['1', 'H0MFCNI0', 'HTS ID를 입력하세요']]
