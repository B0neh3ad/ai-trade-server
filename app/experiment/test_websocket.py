...
async def connect():
    try:
        ...
        g_appkey = "PSpmc6uGwzPG9xKRTZYF37No4NDnQALmFqDe"
        g_appsecret = "aPb+EkEAqG8TQsabH8r0XFA1MD0BZhEJzxuCZ4v0O3UXn66SuKQAhsl3I/JWibSFDKnilyr5bUAqqlMyZNuocbwHOTHo+ohOoMcgvszldnrTYSNaz5S3PH/tN5MeRltPXw9DPGcgeEM9vqNBLS3P7ePcZUad8DlsFFn12MXA7aTinaRyQZE="
        ...
        code_list = [['1','H0IFASP0','101W06'],['1','H0IFCNT0','101W06']] # 지수선물호가, 체결가
        ...
        code_list = [['1', 'H0EUCNT0', '101W06'], ['1', 'H0EUASP0', '101W06'], ['1', 'H0EUANC0', '101W06']]#, ['1', 'H0EUCNI0', 'HTS ID를 입력하세요']]

        ### 3-5. 국내 야간선물(CME) 호가, 체결가, 체결통보 ###
        code_list = [['1', 'H0MFCNT0', '101W06'], ['1', 'H0MFASP0', '101W06']]#, ['1', 'H0MFCNI0', 'HTS ID를 입력하세요']]
        ...
        # code_list = [['1','H0STASP0','005930'],['1','H0STCNT0','005930'],['1', 'H0STANC0', '005930'],
        #              ['1','HDFSASP0','DNASAAPL'],['1','HDFSCNT0','DNASAAPL'],
        #              ['1','HDFSASP1','DHKS00003'],['1','HDFSCNT0','DHKS00003'],
        #              ['1','H0IFASP0','101T12'],['1','H0IFCNT0','101T12'],['1','H0IOASP0','201T11317'],['1','H0IOCNT0','201T11317'], ['1','H0CFASP0','175T11'],['1','H0CFCNT0','175T11'],['1', 'H0ZFCNT0', '111V06'], ['1', 'H0ZFASP0', '111V06'],['1', 'H0ZOCNT0', '211V05059'], ['1', 'H0ZOASP0', '211V05059'],
        #              ['1','HDFFF020','FCAZ22'],['1','HDFFF010','FCAZ22'],['1','HDFFF020','OESH23 C3900'],['1','HDFFF010','OESH23 C3900']]
