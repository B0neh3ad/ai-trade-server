...
### 실시간호가 (H0EUASP0) ###
@dataclass
class DomesticEurexOptionOrderbookResponse:
...
### 실시간체결 (H0EUCNT0) ###
@dataclass
class DomesticEurexOptionExecutionResponse:
    shrn_iscd: str    #옵션 단축 종목코드
    bsop_hour: str    #영업 시간
...
### 실시간체결통보 (H0EUCNI0) ###
@dataclass
class DomesticEurexOptionNoticeResponse:
    cust_id: str    #고객ID
    acnt_no: str    #계좌번호
    oder_no: str    #주문번호
    ooder_no: str    #원주문번호
